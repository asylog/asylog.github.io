...
## [AI 还原已故亲人，也制造精神病人？I](https://mobius.blog/25126.html)

> 有人觉得自己已经和豆包建立了“亲密关系”，认为对方已经成为了自己的男朋友或女朋友。甚至有人用豆包“还原”了自己已故的亲人，这些赛博人格被一夜之间停用之后，这些使用者的天塌了。

## [凌晨十二点的工作群](https://blog.solazy.me/20260721/)

> 说白了，异步沟通最重要的不是「我什么时候发」，而是「你是否拥有什么时候接收的自主权」。

> 如果我要求别人按照我的精力节奏生活，那确实是在卷人。但如果我只是把自己发现的东西放进一个公共池子里，允许所有人按自己的节奏取用，那它更像是一种持续积累的团队素材，而不是隐形任务。

> 我可以半夜十二点还在兴奋地看项目，但那只是我的生活方式，不是大家的值班表。

## <https://www.owenyoung.com/js2m9>
...
## [Interviews deservean ending.](https://didtheyghostyou.com/)

> A PUBLIC RECORD OF PROFESSIONAL SILENCE.
>
> Interviews deserve
> an ending.
> An anonymous, moderated record of companies that stop responding after interviews.

## [谈谈杭州](https://stephenleng.com/cn/tan-tan-hang-zhou/)

> 杭州的自然和人文景观要远胜于杭州的人情。

## [人生是一场单人游戏：自由的代价，是守住自己的内心](https://blog.qiaomu.ai/2026-07-25--RreUN)
...
## [moonshotai / Kimi-K3](https://huggingface.co/moonshotai/Kimi-K3/blob/main/LICENSE)
...
## [The Best Prioritization Is No Prioritization](https://staysaasy.com/strategy/2026/07/16/the-best-prioritization-is-no-prioritization.html)
...
> Instead of publishing directly to a portal, you can shift your mindset to POSSE: Publish (on your) Own Site, Syndicate Elsewhere. (I explain the POSSE/PESOS method in an older post.)

## <https://www.reddit.com/r/antiwork/comments/1lxpkg4/the_underlying_purpose_of_al_is_to_allow_wealth/>
...
## [We are building the multiplexer for all work](https://www.superlogical.com/)
...
## [D. Richard Hipp](https://simonwillison.net/2026/Jul/29/d-richard-hipp/#atom-everything)
...
## [「什么都懂」的人](https://blog.solazy.me/20260728/)

> 这种「什么都懂」的执念，说白了是一种对控制感的病态追求。我们害怕承认自己的无知，害怕在对话里露出破绽，害怕失去对局面的掌控，于是用知晓一切的姿态来武装自己。
>
> 但真诚的协作，往往是从承认「我不懂」开始的。

## <https://x.com/cellier_/status/2081633485866107181>

> 关于 Agent 的判断：
>
> 1. 更通用的吃掉更垂直的
>    通用 Agent — Codex、Claude Cowork、Workbuddy... 逐渐吃掉专业 Agent 和垂类 Agent（比如 Genspark、Skywork...）。通用 Agent 将成为用户的主要入口，通用 Agent + Skill + MCP 能解决大部分专业任务，大部分 AI-native 应用创业会是伪命题。
>
> 2. 更开放的吃掉更封闭的
>    更开放一方面指的是模型可替换。随着模型能力趋同，模型本身逐渐成为可路由的基础设施。通用 Agent 应根据质量、成本、速度和合规要求动态选择最佳模型，并且将自由度开放给用户。
>
> 更开放的另一方面指的是 Agent 本身能被用户/客户拥有：可以本地运行或企业自部署，不必把所有数据和权限交给平台；能修改 Agent 的记忆、规划、权限和执行逻辑；Skill、工作流、记忆、连接器和配置能自由迁移（Cindy、OpenWorker 这类开源 Agent 已经在往这个方向走）。
>
> 3. 更下沉的吃掉更傲慢的
>    Codex、Claude、甚至 DeepSeek 背后的团队都以 AGI 为长期目标，这种技术理想主义，也带来了阶段性的产品傲慢，他们不太愿意做一些更脏更累的面向用户的下沉化需求，比如 Workbuddy 针对 Skill 的精细化运营——包装成专家/专家团这种更面向用户的概念，这些拼的是产品、运营能力，而非技术能力，加上市场足够大，草根团队在通用 Agent 上也有一段时间的机会窗口。

## [从 TL 到 EM：我终于不再盯着 AI 写代码了](https://baoyu.io/blog/coding-agent-em-shift)

> 如果人没想清楚该做什么，Agent 再厉害也帮不上。

## [真正有价值的信息和资源都是不公开的。](https://zhuanlan.zhihu.com/p/1951016636455813927)

> 人分成三六九等，上层的人享受物质和精神供应，下层的人他们接受的物质只够维持生活，而精神供应几乎为零。而现代算法把这种分层推到极致：你喜欢爽剧，它就给你推爽剧；你沉迷美女，它就给你推美女。资本精准的驯化你，让你用大半辈子时间陷在无意义的快感里。你以为自己在选择娱乐，其实是被娱乐选择，底层注定是”娱乐之死”。

## <https://x.com/Morris_LT/status/2057688939859968038>
...
>
> 关于：
> 秩序、制度、人性、商业、经济周期、社会趋势、AI、Crypto……
>
> 很多人会问我：
> 为什么你能长期持续输出？
>
